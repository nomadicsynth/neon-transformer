#!/bin/bash
diff_attention_modes=("expressive" "constrained")
for mode in "${diff_attention_modes[@]}"; do
    python train.py --output_dir "./outputs/spark-diffattn-${mode}-baseline" --overwrite_output_dir True \
                    ...
                    --project_name neon-test --run_name "spark-diffattn-${mode}-baseline" \
                    ...
                    --seed 42 --diff_attention_mode "${mode}"
done