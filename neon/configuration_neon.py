    ...
    r"""
        ...
        Args:
            ...
            max_position_embeddings (`int`, *optional*, defaults to `4096`):
                The maximum sequence length that this model might ever be used with. Sliding window attention
            ...
            sliding_window (`int`, *optional*, defaults to None):
                Sliding window attention window size. If not specified, will default to `None`, which will disable
        ...
        >>> # Initializing a Neon 7B style configuration
        >>> configuration = NeonConfig()

        >>> # Initializing a model from the Neon 7B style configuration
